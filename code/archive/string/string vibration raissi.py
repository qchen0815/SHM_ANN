...
class PhysicsInformedNN:
    ...
    def __init__(self, x0, w0, w_t0, tb, X_f, layers, lb, ub):
        ...
        # tf Graphs
        self.w0_pred, self.w_t0_pred = self.net_w(self.x0_tf, self.t0_tf) # initial points prediction
        self.w_lb_pred, _ = self.net_w(self.x_lb_tf, self.t_lb_tf) # lb points prediction
        self.w_ub_pred, _ = self.net_w(self.x_ub_tf, self.t_ub_tf) # ub points prediction
